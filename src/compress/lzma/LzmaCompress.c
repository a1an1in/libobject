...
static class_info_entry_t zcompress_class_info[] = {
    ...
    Init_Vfunc_Entry(3, LzmaCompress, compress_file, __compress_file),
    Init_Vfunc_Entry(4, LzmaCompress, uncompress_file, __uncompress_file),
    Init_End___Entry(5, LzmaCompress),
};
