...
#define ARG_ARGSNIC			     DBG_BUSINESS_ARG		 	<< 8 | DBG_DBG_ARGSNIC 
#define ARG_FATAL				 DBG_BUSINESS_ARG		 	<< 8 | DBG_FATAL 
#define ARG_ERROR				 DBG_BUSINESS_ARG		 	<< 8 | DBG_ERROR 
#define ARG_WARNNING			 DBG_BUSINESS_ARG		 	<< 8 | DBG_WARNNING 
#define ARG_SUC				     DBG_BUSINESS_ARG		 	<< 8 | DBG_SUC 
#define ARG_CORRECT			     DBG_BUSINESS_ARG		 	<< 8 | DBG_CORRECT 
#define ARG_VIP 				 DBG_BUSINESS_ARG		 	<< 8 | DBG_VIP 
#define ARG_FLOW				 DBG_BUSINESS_ARG		 	<< 8 | DBG_FLOW 
#define ARG_IMPORTANT			 DBG_BUSINESS_ARG		 	<< 8 | DBG_IMPORTANT 
