...
#define DBG_SUC_COLOR 			HIGHLIGHT_FLAG << 7 | BGC(BLACK)  | FTC(WHITE) | REVERSE_COLOR_FLAG 
...
#define DBG_INFO_COLOR  		HIGHLIGHT_FLAG << 7 | BGC(BLUE)   | FTC(WHITE) | REVERSE_COLOR_FLAG 
...
#define DBG_DETAIL_COLOR 		HIGHLIGHT_FLAG << 7 | BGC(BLACK)  | FTC(WHITE)
