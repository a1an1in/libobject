...
static int __set_key(Aes *sk, char *key, void *key_len)
{
    return 0;
}

static int __encrypt(Aes *sk, void *in, int in_len, void *out, int out_len)
{

    return 0;
}

static int __decrypt(Aes *sk, void *in, int in_len, void *out, int out_len)
{
    return 0;
}
