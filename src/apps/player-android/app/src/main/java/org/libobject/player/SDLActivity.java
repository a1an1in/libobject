...
public class SDLActivity extends Activity implements View.OnSystemUiVisibilityChangeListener {
    ...
    protected static org.libobject.player.SDLGenericMotionListener_API12 mMotionListener;
    protected static HIDDeviceManager mHIDDeviceManager;

    // This is what SDL runs in. It invokes SDL_main(), eventually
    protected static Thread mSDLThread;

    protected static org.libobject.player.SDLGenericMotionListener_API12 getMotionListener() {
        if (mMotionListener == null) {
            if (Build.VERSION.SDK_INT >= 26) {
                mMotionListener = new org.libobject.player.SDLGenericMotionListener_API26();
            } else 
            if (Build.VERSION.SDK_INT >= 24) {
                mMotionListener = new org.libobject.player.SDLGenericMotionListener_API24();
            } else {
                mMotionListener = new org.libobject.player.SDLGenericMotionListener_API12();
            }
        }
...
class SDLSurface extends SurfaceView implements SurfaceHolder.Callback,
    ...
    public boolean onTouch(View v, MotionEvent event) {
        ...
        if ((event.getSource() == InputDevice.SOURCE_MOUSE || event.getSource() == 12290) && SDLActivity.mSeparateMouseAndTouch) {
            ...
            org.libobject.player.SDLGenericMotionListener_API12 motionListener = SDLActivity.getMotionListener();
...
class DummyEdit extends View implements View.OnKeyListener {
    ...
    public boolean onKeyPreIme (int keyCode, KeyEvent event) {
        ...
        // FIXME: Discussion at http://bugzilla.libobject.org/show_bug.cgi?id=1639
...
class SDLInputConnection extends BaseInputConnection {
    ...
    public boolean deleteSurroundingText(int beforeLength, int afterLength) {
        ...
        // and https://bugzilla.libobject.org/show_bug.cgi?id=2265
