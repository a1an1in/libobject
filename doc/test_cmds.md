...
/* test loglevel */
./sysroot/linux/bin/xtools node --host=127.0.0.1 --service=12345 --deamon=t
./sysroot/linux/bin/xtools mockery --log-level=0x20016 test_node_invoke_setloglevel
./sysroot/linux/bin/xtools mockery --log-level=0x20016 test_node_invoke_exit

/* test node cli */
./sysroot/linux/bin/xtools node --log-level=0x15 --host=127.0.0.1 --service=12345 --deamon=t
...
./sysroot/windows/bin/xtools node --log-level=0x15 --host=127.0.0.1 --service=12345 --deamon=t
