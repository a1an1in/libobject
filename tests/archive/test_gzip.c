...
static int test_gzip(TEST_ENTRY *entry, int argc, void **argv)
{
    ...
    Archive *archive;
    char buf[65536];
    char *src_file = "/home/alan/workspace/libobject/res/test_gzip.txt";
    char *dst_file = "/home/alan/workspace/libobject/res/test_gzip.gz";
    ...
    TRY {
        ...
        EXEC(archive->compress(archive, src_file, dst_file));
